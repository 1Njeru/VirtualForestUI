...
const About = () => {
  return (
   ...
   '>
        ...
        <div className=''>
            <h2 className='text-xl lg:pt-0'>Virtual Forest</h2>
            <div className='pt-4'>
            <span className='font-light'>Virtual Forest is a web based game that enables <br/>
            ...
            <h2 className='text-xl pt-6 lg:pt-8'>Zuraverse</h2>
            <div className='pt-4'>
            <span className='font-light'>Zuraverse is a novel Play-Earn-Converse model of<br /> 
        ...
        <img src={forest} alt='' className='w-[456px] h-[253px]' />
            <h2 className='text-xl pt-8 lg:pt-12'>Planters Organization</h2>
            <div className='pt-4'>
            <span className='font-light'>Zuraverse is a novel Play-Earn-Converse model of<br />
